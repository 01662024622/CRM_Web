                ...
                <div class="container">
                    <div class="container-form">
                        <div class="card-details">
                            <h3 class="title">Khảo sát về sự hài lòng của khách hàng</h3>
                            <div class="row">
                                <div class="form-group col-sm-12">
                                    <label for="card-holder" class="form-label-header">Anh/ Chị đánh giá như thế nào về thái độ của Nhân viên kinh doanh HT Auto?</label>
                                ...
                                <div class="form-group col-sm-12">
                                    <label for="card-holder" class="form-label-header">Anh/ Chị đánh giá thế nào về kiến thức sản phẩm của nhân viên kinh doanh?</label>
                                    <div class="form-check">
                                ...
                                <div class="form-group col-sm-12">
                                    <label for="card-holder" class="form-label-header">Anh chị đánh giá như thế nào về mức độ đa dạng và đầy đủ của các mặt hàng tại HT?</label>
                                ...
                                <div class="form-group col-sm-12">
                                    <label for="card-holder" class="form-label-header">Anh/ Chị đánh giá ntn về chất lượng sản phẩm của HT Auto?</label>
                                    <div class="form-check">
                                ...
                                <div class="form-group col-sm-12">
                                  <label  for="card-holder" class="form-label-header">Ý kiến đóng góp ( Nếu có)</label>
