                            ...
                            <div class="row">
                                <div class="form-group col-sm-12">
                                    ...
                                    <div class="form-check">
                                      <input class="form-check-input" type="radio" name="work" id="exampleRadios1" value="Rất tốt" checked>
                                      <label class="form-check-label form-label" for="exampleRadios1">Rất tốt</label>
                                  </div>
                                  <div class="form-check">
                                      <input class="form-check-input" type="radio" name="work" id="exampleRadios2" value="Tốt">
                                      <label class="form-check-label form-label" for="exampleRadios2">Tốt</label>
                                  </div>
                                  <div class="form-check">
                                    <input class="form-check-input" type="radio" name="work" id="exampleRadios3" value="Bình thường">
                                    <label class="form-check-label form-label" for="exampleRadios2">Bình thường</label>
                                </div>
                                <div class="form-check">
                                  <input class="form-check-input" type="radio" name="work" id="exampleRadios4" value="Chưa được tốt lắm">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-sm-12">
                            ...
                            <div class="form-check">
                              ...
                              <label class="form-check-label form-label" for="defaultCheck1">CT-Nhiệt tình trong công việc hơn nữa</label>
                          </div>
                          <div class="form-check">
                              <input class="form-check-input" type="checkbox" value="" name="" id="defaultCheck1">
                              <label class="form-check-label form-label" for="defaultCheck1">CT-Cần phải linh hoạt hơn trong công việc khi có phát sinh</label>
                          </div>
                          <div class="form-check">
                              <input class="form-check-input" type="checkbox" value="" name="" id="defaultCheck1">
                              <label class="form-check-label form-label" for="defaultCheck1">CT-Cần am hiểu về các phạm trù công việc khác liên quan hơn để phục vụ công việc</label>
                          </div>
                          <div class="form-check">
                              <input class="form-check-input" type="checkbox" value="" name="" id="defaultCheck1">
                              <label class="form-check-label form-label" for="defaultCheck1">CT-Chậm hoàn thành công việc rất nhiều, cần hoàn thành công việc đúng hạn</label>
                          </div>
                          <div class="form-check">
                              <input class="form-check-input" type="checkbox" value="" name="" id="defaultCheck1">
                              <label class="form-check-label  form-label" for="defaultCheck1">CT-Cần cải thiện việc phục vụ khách hàng, khách hàng phản hồi không tốt nhiều</label>
                          </div>

                          <div class="form-check">
                              <label style="max-width: 30%">

                                  <label><input class="form-check-input" type="checkbox" value="" name="" id="defaultCheck1"></label>
                              ...
                              <label class="form-check-label  form-label" for="defaultCheck1" style="min-width: 70%">
                                <input class="text-button" type="text" value="" name="" placeholder="Câu trả lời của bạn">
                            </label>
                        </div>
                    </div>
...
<script src="{{ asset('/js/main/review360/intergration.js') }}"></script>
